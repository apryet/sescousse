...
mf_file=os.path.join('..','data','MeteoFr','ETP_daily.csv')
...
riv.stress_period_data = riv_spd

# --- drn package 
drn = ml.get_package('drn_0')
drn_rec0 = drn.stress_period_data.get_data()[0]
#drn.stress_period_data = {i:drn_rec0 for i in range(nper)}
drn.stress_period_data = {0:drn_rec0}

# --- ghb package 
ghb = ml.get_package('ghb_0')
ghb_rec0 = ghb.stress_period_data.get_data()[0]
#ghb.stress_period_data = {i:ghb_rec0 for i in range(nper)}
ghb.stress_period_data = {0:ghb_rec0}
