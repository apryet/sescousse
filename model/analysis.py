...
hds_2d = hdfile.get_alldata()[0,0,:,:]
ax.plot(hds_2d[:, int(ml.dis.ncol.data/2)],label='ss')
fig.tight_layout()
...
convert 'h_%d.png[0-274]' -scale 1066x800 -delay 20 -coalesce -layers Optimize -fuzz 2% +dither hmap.gif
